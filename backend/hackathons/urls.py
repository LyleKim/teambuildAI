...
urlpatterns = [
    ...
    path('hackathons/<int:hackathon_id>/todos/', views.TodoItemListCreateView.as_view()),
    path('hackathons/<int:hackathon_id>/participants/manual/', views.ManualParticipantListCreateView.as_view()),
    ...
    path('todos/<int:pk>/', views.TodoItemDetailView.as_view()),
    path('participants/manual/<int:pk>/', views.ManualParticipantDeleteView.as_view()),
