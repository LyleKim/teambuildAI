...
const ROUTE_TABLE: { pattern: string; value: RouteDef }[] = [
  ...
  { pattern: "/login", value: { render: () => <LoginScreen />, auth: false } },
  {
    ...
    value: { render: () => <AuthCallbackScreen />, auth: false },
  },
  {
    pattern: "/onboarding/role",
    value: { render: () => <RoleSelectScreen />, auth: true },
  },

  {
    pattern: "/hackathons",
    value: { render: () => <SearchScreen />, auth: false },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <JoinTypeScreen hackathonId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <ProfileSetupScreen hackathonId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <TeamSetupScreen hackathonId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <AIResultsScreen hackathonId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <DetailScreen hackathonId={id} />}
        />
      ),
      auth: false,
    },
...

  {
    pattern: "/profile",
    value: {
      render: () => <ProfileSetupScreen hackathonId={null} />,
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <MemberProfileScreen userId={id} />}
        />
      ),
      auth: true,
    },
  ...
  {
    pattern: "/coffeechats",
    value: { render: () => <CoffeeChatInboxScreen />, auth: true },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <CoffeeChatMatchedScreen coffeechatId={id} />}
        />
      ),
      auth: true,
    },
  ...
  {
    pattern: "/messages",
    value: { render: () => <MessagesScreen />, auth: true },
  },
  {
    pattern: "/messages/:id",
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <ChatScreen threadId={id} />}
        />
      ),
      auth: true,
    },
  ...
  {
    pattern: "/my/status",
    value: { render: () => <MyStatusScreen />, auth: true },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <TeamSpaceScreen hackathonId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: {
      render: (p) => (
        <Guarded
          id={numericParam(p, "id")}
          render={(id) => <TeamEditScreen teamId={id} />}
        />
      ),
      auth: true,
    },
  },
  {
    ...
    value: { render: () => <MyReviewsScreen />, auth: true },
  },
  { pattern: "/mypage", value: { render: () => <MyPageScreen />, auth: true } },
  {
    pattern: "/notifications",
    value: { render: () => <NotificationsScreen />, auth: true },
  },
]
