            ...
            >
              <div className="flex items-center justify-between mb-3 gap-3">
                <div className="min-w-0">
                  <button
                    ...
                    className="font-bold text-[15px] text-ink hover:text-brand transition-colors text-left"
                  >
                    {p.hackathon.title}
                  </button>
                ...
                {p.ended_at ? (
                  <span className="text-[12px] font-semibold px-3 py-1 rounded-full flex-shrink-0 text-ink-soft bg-border/60">
                    ✅ 종료됨
                  </span>
                ) : (
                  <span
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="border border-[#FECDD3] rounded-xl px-4 py-2 text-[13px] font-medium text-[#F43F5E] hover:bg-[#FFF1F2] transition-colors disabled:opacity-50"
                >
                  삭제
                </button>
              </div>
