...
공모전 수상 경험은 대학생에게 의미 있는 포트폴리오가 되지만, 실력과 의지가 있어도 **"혼자 다 해야 한다"는 부담** 때문에 참가를 포기하는 경우가 많습니다.  
...
> 실제로 팀원 중 한 명이 공모전 구인글을 올렸을 때, 수십 명이 글을 조회했지만 연락은 단 한 건도 오지 않았습니다. **"왜 아무도 먼저 말을 걸지 않았을까?"** 라는 질문에서 이 프로젝트가 시작되었습니다.
...
- **공모전 정보 탐색** — 진행 중인 공모전·대회 정보를 한곳에서 확인  
